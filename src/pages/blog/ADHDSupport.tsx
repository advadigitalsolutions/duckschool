        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="prose prose-lg max-w-none space-y-6 text-foreground">
              ...
              <h2 className="text-2xl font-bold mt-8">How SmartCore Supports ADHD Learners</h2>
              ...
              <p>
                SmartCore offloads working memory demands:
              </p>
              <ul className="space-y-2">
              ...
              <p>
                "Before SmartCore, homework battles destroyed our relationship. Now he's self-motivated because the system works <em>with</em> his brain, not against it."
              </p>
              ...
              <p>
                Traditional school forces them into a neurotypical box. SmartCore builds the learning environment around how their brain actually works.
              </p>
              ...
              <p className="text-xl font-semibold">
                SmartCore was. And the results speak for themselves.
              </p>
