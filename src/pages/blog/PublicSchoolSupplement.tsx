          ...
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="prose prose-lg max-w-none space-y-6 text-foreground">
              <p className="text-xl text-muted-foreground">
                Not replacing school—enhancing it. Masterymode.ai fills the gaps with enrichment, intervention, and summer learning that keeps kids on track.
              </p>
              ...
              <h2 className="text-2xl font-bold mt-8">Three Ways Families Use Masterymode.ai as a Supplement</h2>

              <h3 className="text-xl font-bold mt-6">1. Enrichment for Advanced Learners</h3>
              <p>
                Your fourth-grader is crushing school math but the district won't move them to fifth-grade content. Instead of being bored for a year, use Masterymode.ai to:
              </p>
              ...
              <p>
                <strong>Real example:</strong> "My daughter's third-grade teacher said she was 'doing fine.' But she was reading at a seventh-grade level and finishing assignments in 10 minutes. Masterymode.ai gave her challenging work that actually engaged her brain. Now she's excited about learning again."
              </p>
              ...
              <p>
                <strong>Real example:</strong> "My son was struggling with fractions in fifth grade. The teacher didn't have time to reteach, and he was expected to 'figure it out.' Masterymode.ai found the gaps in his understanding (turns out he never fully mastered multiplication), filled them, and now he's caught up and confident."
              </p>
              ...
              <p>
                Use Masterymode.ai over the summer to:
              </p>
              <ul className="space-y-2">
              ...
              <p>
                Masterymode.ai provides expert-level tutoring across all subjects, available 24/7, with built-in diagnostics—at a fraction of the cost.
              </p>
              ...
              <p>
                Masterymode.ai is designed to align with state standards that guide your child's public school curriculum. We're teaching the same concepts—just with personalized pacing, adaptive instruction, and more one-on-one attention than a classroom teacher can provide.
              </p>
              <p>
                Think of it like this: School provides the foundation. Masterymode.ai provides the scaffolding, support, and extension work that ensures every child can build as high as their potential allows.
              </p>

              <h2 className="text-2xl font-bold mt-8">Time Commitment: Less Than You Think</h2>
              <p>
                Most families use Masterymode.ai for:
              </p>
              <ul className="space-y-2">
              ...
              <h2 className="text-2xl font-bold mt-8">Public School + Masterymode.ai = Best of Both Worlds</h2>
              <p>
              ...
              <blockquote className="border-l-4 border-primary pl-4 italic my-6">
                "We love our public school, but my son was getting lost in the shuffle. Masterymode.ai gave him the individualized attention he needed to catch up. His teacher even noticed the improvement and asked what we were doing differently."
              </blockquote>
              <blockquote className="border-l-4 border-primary pl-4 italic my-6">
                "My daughter was bored in school—she'd finish work early and then distract other kids. Masterymode.ai gives her challenging enrichment work that keeps her engaged. She still goes to school for friends and activities, but now her brain is challenged too."
              </blockquote>
              <blockquote className="border-l-4 border-primary pl-4 italic my-6">
                "Summer slide was destroying all the progress my kids made during the school year. Using Masterymode.ai over summer break meant they came back ready to learn instead of having to spend two months re-learning what they forgot."
              </blockquote>
              ...
              <p>
                Masterymode.ai isn't a criticism of public education—it's a tool that helps your child get the individualized attention they deserve while still benefiting from the social and structural advantages of traditional school.
              </p>
              ...
              <div className="border-t pt-8 mt-12">
                <div className="bg-muted/50 rounded-lg p-6 mb-6">
                  ...
                  <p className="mb-4">
                    Whether your child needs enrichment, intervention, or summer learning, Masterymode.ai provides personalized instruction that works alongside their public school education. Start with a free diagnostic to see exactly where they are and what they need.
                  </p>
