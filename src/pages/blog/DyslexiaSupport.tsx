          ...
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="space-y-4">
              ...
              <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                Reading Shouldn't Be a Barrier to Learning: How Duckschool Supports Dyslexic Students
              </h1>
            </div>
            ...
            <div className="prose prose-lg max-w-none space-y-6 text-foreground">
              ...
              <h2 className="text-2xl font-bold mt-8">How Duckschool Levels the Playing Field</h2>
              ...
              <p>
                Duckschool offers infinite input options and flexible output options. We assess understanding, not reading speed.
              </p>
