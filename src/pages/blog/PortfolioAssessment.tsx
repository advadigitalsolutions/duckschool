          ...
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="prose prose-lg max-w-none space-y-6 text-foreground">
              <p className="text-xl text-muted-foreground">
                Multiple-choice tests can't capture creativity, critical thinking, or real-world problem solving. SmartCore's portfolio system documents the learning that actually matters.
              </p>
