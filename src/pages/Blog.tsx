...
export default function Blog() {
  ...
  const posts = [
    ...
    { slug: 'bridging-learning-gaps', title: 'Bridging Learning Gaps: How AI Identifies and Fills Knowledge Holes', excerpt: 'Your child struggles with fractions but you\'re not sure why. AI diagnostics pinpoint the exact prerequisite skills they\'re missing.', date: 'January 12, 2025', category: 'Academic Support', readTime: '8 min read', image: studentFocusedLearning },
    { slug: 'adhd-support', title: 'Built for ADHD Brains: How SmartCore Turns Executive Function Challenges into Strengths', excerpt: 'ADHD brains are brilliantly wired for depth, creativity, and hyperfocus—when the environment supports them.', date: 'January 12, 2025', category: 'Neurodivergence', readTime: '8 min read', image: childExploringRuins },
    ...
    { slug: 'expat-families', title: 'World-Schooling Made Easy: How SmartCore Supports Expat and Traveling Families', excerpt: 'From Tokyo to Tanzania, maintain US educational standards while embracing the world as your classroom.', date: 'January 8, 2025', category: 'Lifestyle', readTime: '7 min read', image: happyStudentTablet },
    { slug: 'learning-differences', title: 'From Anxiety to Achievement: Supporting Students with Learning Differences', excerpt: 'Dyscalculia, dysgraphia, processing disorders—SmartCore\'s accessibility features turn learning differences into opportunities.', date: 'January 5, 2025', category: 'Special Education', readTime: '8 min read', image: happyStudentTablet },
    { slug: 'just-in-time-curriculum', title: 'Just-In-Time Curriculum: Teaching What Your Child Needs, Exactly When They Need It', excerpt: 'AI-powered learning delivers personalized instruction based on daily diagnostic data.', date: 'January 5, 2025', category: 'Innovation', readTime: '8 min read', image: portugalCityscape },
    { slug: 'independent-learners', title: 'Creating Independent Learners: Building Self-Directed Study Skills That Last a Lifetime', excerpt: 'The goal isn\'t to homeschool forever—it\'s to create learners who don\'t need you hovering.', date: 'January 3, 2025', category: 'Student Development', readTime: '7 min read', image: studentTakingNotes },
    { slug: 'schools-and-charters', title: 'Scaling Personalized Learning: How SmartCore Serves Private Schools, Charters, and Pods', excerpt: 'Personalized, AI-powered education for schools—differentiating instruction at scale.', date: 'January 3, 2025', category: 'Scaling Education', readTime: '9 min read', image: girlReadingIndependently },
    { slug: 'ai-personalization', title: 'The Future of Homeschooling: AI-Powered Personalization at Scale', excerpt: 'What if every child had a world-class tutor available 24/7? AI makes truly personalized education possible.', date: 'January 1, 2025', category: 'Future of Education', readTime: '9 min read', image: homeschoolParentLaptop },
    { slug: 'rigor-and-wellbeing', title: 'Balancing Rigor and Well-Being: Academic Excellence Without the Burnout', excerpt: 'High standards don\'t mean high stress. Learn how to keep learning rigorous but sustainable.', date: 'December 30, 2024', category: 'Holistic Education', readTime: '8 min read', image: parentChildBonding },
    { slug: 'portfolio-assessment', title: 'Portfolio-Based Assessment: Capturing Real Learning Beyond Traditional Tests', excerpt: 'Multiple-choice tests can\'t capture creativity or critical thinking. Portfolio systems document learning that matters.', date: 'December 28, 2024', category: 'Assessment Methods', readTime: '7 min read', image: studentViolinPractice },
    ...
    { slug: 'project-based-learning', title: 'Teaching Critical Thinking: Project-Based Learning Made Easy with AI', excerpt: 'Project-based learning is powerful but time-intensive. AI generates custom projects aligned to standards.', date: 'December 26, 2024', category: 'Teaching Methods', readTime: '8 min read', image: coffeeStudySession },
    ...
    { slug: 'state-standards', title: 'From California to Coast-to-Coast: Bringing Standards-Aligned AI to All 50 States', excerpt: 'We started with California Common Core. Now we support every US state.', date: 'December 20, 2024', category: 'Standards', readTime: '8 min read', image: vintageReportCard },
    ...
    { slug: 'public-school-supplement', title: 'Supplementing Public School: Enrichment and Intervention That Actually Works', excerpt: 'Your child attends public school but needs extra support or challenge? We fill gaps and extend learning.', date: 'December 18, 2024', category: 'Hybrid Learning', readTime: '6 min read', image: modernReportCard },
    { slug: 'why-diagnostics-arent-tests', title: 'Why Diagnostics Aren\'t Tests (And Why That Changes Everything)', excerpt: 'Understanding the difference between discovery and judgment.', date: 'December 15, 2024', category: 'Philosophy', readTime: '5 min read', image: happyLibraryStudent }
  ];
