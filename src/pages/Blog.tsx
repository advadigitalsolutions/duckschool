...
export default function Blog() {
  ...
  const posts = [
    ...
    { slug: 'pedagogies-supported', title: 'One Platform, Every Pedagogy: How Masterymode.ai Adapts to Your Teaching Philosophy', excerpt: 'From Montessori to Classical, Charlotte Mason to unschooling—discover how our AI-powered platform supports any approach.', date: 'January 15, 2025', category: 'Philosophy', readTime: '10 min read' },
    ...
    { slug: 'adhd-support', title: 'Built for ADHD Brains: How Masterymode.ai Turns Executive Function Challenges into Strengths', excerpt: 'ADHD brains are brilliantly wired for depth, creativity, and hyperfocus—when the environment supports them.', date: 'January 12, 2025', category: 'Neurodivergence', readTime: '8 min read' },
    ...
    { slug: 'dyslexia-support', title: 'Reading Shouldn\'t Be a Barrier to Learning: How Masterymode.ai Supports Dyslexic Students', excerpt: 'Dyslexic students are often brilliant thinkers trapped behind a reading barrier. When we remove it, they shine.', date: 'January 10, 2025', category: 'Accessibility', readTime: '9 min read' },
    ...
    { slug: 'expat-families', title: 'World-Schooling Made Easy: How Masterymode.ai Supports Expat and Traveling Families', excerpt: 'From Tokyo to Tanzania, maintain US educational standards while embracing the world as your classroom.', date: 'January 8, 2025', category: 'Lifestyle', readTime: '7 min read' },
    { slug: 'learning-differences', title: 'From Anxiety to Achievement: Supporting Students with Learning Differences', excerpt: 'Dyscalculia, dysgraphia, processing disorders—Masterymode.ai\'s accessibility features turn learning differences into opportunities.', date: 'January 5, 2025', category: 'Special Education', readTime: '8 min read' },
    ...
    { slug: 'schools-and-charters', title: 'Scaling Personalized Learning: How Masterymode.ai Serves Private Schools, Charters, and Pods', excerpt: 'Personalized, AI-powered education for schools—differentiating instruction at scale.', date: 'January 3, 2025', category: 'Scaling Education', readTime: '9 min read' },
