...
export default function Blog() {
  ...
  const posts = [
    ...
    { slug: 'busy-families', title: 'Homeschooling Without the Burnout: For Busy Families Who Need More Hours in the Day', excerpt: 'Working from home, managing multiple kids—and teaching school? AI makes it possible.', date: 'December 28, 2024', category: 'Homeschooling', readTime: '7 min read', image: exhaustedParent },
